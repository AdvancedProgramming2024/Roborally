...
public class SpaceView extends StackPane implements ViewObserver {
    ...
    public static void drawLaser(List<Space> LOS) {
        ...
        laserImageView.setFitWidth(SPACE_WIDTH-(SPACE_WIDTH/3));
        int rotation = 0;
        switch (heading) {
            case NORTH:
                rotation= 90;
        ...
        for (int i = 1 ; i < LOS.size()-1 ; i++) {
            ...
            laserImageView2.setFitHeight(SPACE_HEIGHT/8);
            laserImageView2.setFitWidth(SPACE_WIDTH);
        ...
        if (hit.getPlayer() != null) {
            ...
            laserImageView3.setFitHeight(SPACE_HEIGHT/8);
            laserImageView3.setFitWidth(SPACE_WIDTH/2);
            switch (heading) {
                case NORTH -> laserImageView3.setTranslateY(SPACE_WIDTH/4);
                case EAST -> laserImageView3.setTranslateX(-SPACE_WIDTH/4);
                case SOUTH -> laserImageView3.setTranslateY(-SPACE_WIDTH/4);
                case WEST -> laserImageView3.setTranslateX(SPACE_WIDTH/4);
            }
            ...
            laserImageView4.setFitHeight(SPACE_HEIGHT/8);
            laserImageView4.setFitWidth(SPACE_WIDTH);
